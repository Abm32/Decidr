  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 pt-24 pb-32 text-center">
        <motion.div {...fade(0)}>
          <span className="inline-block rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-xs font-medium tracking-wide text-blue-300">
        ...
        <motion.h1
          {...fade(0.1)}
          className="mt-8 text-5xl font-bold leading-[1.1] tracking-tight text-white sm:text-6xl lg:text-7xl"
        >
          See your future
          <br />
        ...
        <motion.div {...fade(0.3)} className="mt-10 flex items-center justify-center gap-4">
          <Link
            href="/app"
            className="rounded-full bg-blue-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-600/25 transition hover:bg-blue-500 hover:shadow-blue-500/30"
          >
            Try Decidr Free →
          </Link>
          <a
            href="#how-it-works"
            className="rounded-full border border-gray-700 px-8 py-3.5 text-sm font-medium text-gray-300 transition hover:border-gray-500 hover:text-white"
          >
            How it works
          </a>
        </motion.div>
        ...
        <motion.div
          {...fade(0.5)}
          className="mx-auto mt-20 max-w-3xl overflow-hidden rounded-2xl border border-gray-800 bg-gray-900/80 shadow-2xl shadow-black/40"
        >
      ...
      {/* How it works */}
      <section id="how-it-works" className="relative z-10 mx-auto max-w-4xl px-6 py-24">
        <motion.div {...fade()} viewport={{ once: true }} whileInView="animate" initial="initial" className="text-center">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">How it works</h2>
          <p className="mx-auto mt-4 max-w-xl text-gray-400">Five steps from uncertainty to clarity</p>
        </motion.div>
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 py-24 text-center">
        <motion.div
          ...
          className="rounded-3xl border border-gray-800 bg-gradient-to-b from-gray-900 to-gray-950 px-8 py-16"
        >
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
      ...
      <footer className="relative z-10 border-t border-gray-800/50 py-8 text-center text-xs text-gray-600">
        <span className="text-blue-400">◆</span> Decidr — Decision Intelligence Engine
      </footer>
    </div>
  );
}
